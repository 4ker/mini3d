...
void matrix_set_lookat(matrix_t *m, const vector_t *eye, const vector_t *at, const vector_t *up) {
    ...
    vector_sub(&zaxis, at, eye); // at-eye: eye -> at
    vector_normalize(&zaxis);
    vector_crossproduct(&xaxis, up, &zaxis); // y: up(close), zaxis: z, cross: x
    vector_normalize(&xaxis);
    vector_crossproduct(&yaxis, &zaxis, &xaxis); // cross of x, z: y
